...
export default async function AuditPage({
  ...
  return (
    <main className="mx-auto flex w-full max-w-6xl flex-1 flex-col gap-6 px-6 py-10">
      ...
      <form method="get" className="flex flex-wrap items-end gap-3 rounded-xl border border-slate-200 bg-white p-4 dark:border-slate-800 dark:bg-slate-900">
        ...
        <nav className="flex items-center justify-center gap-3 text-sm">
          {page > 1 && (
            <Link
              ...
              className="rounded-md border border-slate-300 px-3 py-1.5 hover:bg-slate-100 dark:border-slate-700 dark:hover:bg-slate-900"
            >
              ← Anterior
            </Link>
          )}
