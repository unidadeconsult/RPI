...
export default async function TaskDetailPage({
  ...
  return (
    <main className="mx-auto flex w-full max-w-4xl flex-1 flex-col gap-6 px-6 py-10">
      ...
      <section className="grid grid-cols-1 gap-4 rounded-xl border border-slate-200 bg-white p-6 sm:grid-cols-2 dark:border-slate-800 dark:bg-slate-900">
        <div>
          ...
          {canEdit ? (
            <form action={updateTaskStatus} className="mt-1 flex items-center gap-2">
              ...
              <button
                type="submit"
                className="rounded-md bg-slate-900 px-3 py-1.5 text-xs font-medium text-white hover:bg-slate-700 dark:bg-slate-100 dark:text-slate-900"
              >
                Salvar
              </button>
            </form>
        ...
        {canEdit && (
          <form action={addChecklistItem} className="mt-3 flex gap-2">
            ...
            <input
              ...
              className="flex-1 rounded-md border border-slate-300 px-2 py-1.5 text-sm dark:border-slate-700 dark:bg-slate-950"
            />
            <button
              type="submit"
      ...
      <section className="rounded-xl border border-slate-200 bg-white p-6 dark:border-slate-800 dark:bg-slate-900">
        ...
        {canEdit && (
          <form action={addTaskComment} className="mt-3 flex flex-col gap-2">
            ...
            <button
              type="submit"
              className="self-start rounded-md border border-slate-300 px-3 py-1.5 text-sm hover:bg-slate-100 dark:border-slate-700 dark:hover:bg-slate-900"
            >
              Comentar
            </button>
          </form>
